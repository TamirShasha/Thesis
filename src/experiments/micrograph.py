...
MICROGRAPHS = {
    ...
    'whitened002_x10': Micrograph(name='002white_x10.mrc', length=350, occurrences=80, noise_std=10, noise_mean=0),
    '002': Micrograph(name='002.mrc', length=350, occurrences=80, noise_std=1, noise_mean=0)
}
