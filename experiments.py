...
class Experiment:
    ...
    def __init__(self,
        ...
        self._signal_length_options = np.arange(self._d // 4, int(self._d * 2), 3)

        exp_attr = {
            "d": self._d,
            "k": self._k,
            "use_exact_signal_power": use_exact_signal_power,
            "use_exact_k": use_exact_k
        }
